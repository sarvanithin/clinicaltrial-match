...
def test_high_confidence_with_all_passing():
    ...
    result = build_match_result(
        match_id="m1", patient_id="p1", nct_id="NCT1", trial_title="T",
        semantic_score=0.9, constraint_results=constraints, created_at=time.time()
    )
...
def test_medium_confidence_with_some_failures():
    ...
    result = build_match_result(
        match_id="m2", patient_id="p1", nct_id="NCT2", trial_title="T",
        semantic_score=0.7, constraint_results=constraints, created_at=time.time()
    )
...
def test_low_confidence_with_hard_failure():
    ...
    result = build_match_result(
        match_id="m3", patient_id="p1", nct_id="NCT3", trial_title="T",
        semantic_score=0.5, constraint_results=constraints, created_at=time.time()
    )
...
def test_no_constraints_gives_neutral_constraint_score():
    result = build_match_result(
        match_id="m4", patient_id="p1", nct_id="NCT4", trial_title="T",
        semantic_score=0.6, constraint_results=[], created_at=time.time()
    )
...
def test_composite_score_formula():
    ...
    constraints = [_passed("age >= 18"), _passed("has diagnosis: T2DM")]
    result = build_match_result(
        match_id="m5", patient_id="p1", nct_id="NCT5", trial_title="T",
        semantic_score=0.8, constraint_results=constraints, created_at=time.time()
    )
...
def test_top_factors_populated():
    ...
    result = build_match_result(
        match_id="m6", patient_id="p1", nct_id="NCT6", trial_title="T",
        semantic_score=0.9, constraint_results=constraints, created_at=time.time()
    )
